                        ...
                        <form action="{{ route('seller.activation.update') }}" method="POST" class="space-y-6">
                            ...
                            <div class="form-group">
                                ...
                                <input 
                                    ...
                                    name="merchant_id" 
                                    type="text" 
                                    class="block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:border-indigo-500 focus:ring-indigo-500" 
                            ...
                            <!-- Client Key Field -->
                            <div class="form-group">
                                <label for="client_key" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Client Key Midtrans
                                </label>
                                <input 
                                    id="client_key" 
                            ...
                            <!-- Server Key Field -->
                            <div class="form-group">
                                <label for="server_key" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Server Key Midtrans
                                </label>
                                <input 
                                    id="server_key" 
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-green-800 dark:text-green-200 mb-3">
                                Download panduan aktivasi untuk memahami proses aktivasi akun secara detail
                            </p>
