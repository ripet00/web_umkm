@php
// Hanya jalankan query jika user terotentikasi dengan guard 'web'
$itemCount = 0;
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth('web')
                    <!-- Cart Icon -->
                    <a href="{{ route('cart.index') }}" class="relative me-5 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300">
